...
def available_books():
    ...
    book = ref.order_by_child('availability').equal_to("Yes").get()
...
Label(root, text = "Search Available Books", font = ("Helvetica 10 underline"), fg = "black").pack(side = TOP, anchor = "n")

button1 = Button(text = "Find Available Books", command = available_books).pack(pady = 25, side = TOP, anchor = "n")
